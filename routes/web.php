...
Route::resource('admin/warning_letter', 'App\Http\Controllers\Admin\warning_letterController');
Route::get('/laporan/cek_sp', [LaporanController::class, 'index']);
Route::get('/laporan/cek_sp/pdf', [LaporanController::class, 'cetak_pdf']);
Route::get('printout/warning_notice/{id}', function($id){ 
    return LaporanController::cetak_pdf($id);
});
